                ...
                <div class="col-lg-5">
                    <div class="bg-primary rounded h-100 d-flex align-items-center p-5 wow zoomIn" data-wow-delay="0.9s">
                        <form @submit.prevent="handleSubmit">
                            <div class="row g-3">
                                <div class="col-xl-12">
                                    <input type="text" v-model="formData.name"  label="Name" class="form-control bg-light border-0" placeholder="Your Name" style="height: 55px;">
                                     <div class="text-danger" v-if="errors.name">{{ errors.name }}</div>
                                </div>
                                <div class="col-12">
                                    <input type="email" v-model="formData.email"  label="Email"  class="form-control bg-light border-0" placeholder="Your Email" style="height: 55px;">
                                    <div class="text-danger" v-if="errors.email">{{ errors.email }}</div>
                                </div>
                                <div class="col-12">
                                    <select class="form-select bg-light border-0" v-model="formData.service" style="height: 55px;">
                                        <option disabled value="">Select A Service</option>
                                        <option 
                                            v-for="service in digitalServices" 
                                            :key="service.id" 
                                            :value="service.id"
                                        >
                                    ...
                                    <div class="text-danger" v-if="errors.service">{{ errors.service }}</div>
                                </div>
                                <div class="col-12">
                                    <textarea class="form-control bg-light border-0"  v-model="formData.message"  label="Message" rows="3" placeholder="Message"></textarea>
